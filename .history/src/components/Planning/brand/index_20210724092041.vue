  ...
  <div class="distribution-channel-list">
    ...
    >
      ...
      <el-table-column prop="edit" label="操作">
        <template slot-scope="scope">
          <el-button type="primary" size="small" @click="scope.row.show = true">
            编辑
          </el-button>
          <el-button type="primary" size="small" v-show="scope.row.edit">保存</el-button>
          <el-button type="danger" size="small" v-show="scope.row.edit">取消</el-button>
          <el-button @click="scope.row.show = false" type="danger" size="small">
            删除
          </el-button>
        </template>
      </el-table-column>
