          ...
          <el-row :gutter="140">
            ...
            <el-col :span="12">
              <el-row :gutter="40">
                <el-col :span="8">
                  <div class="grid-content bg-purple text-left">
                    <span class="green">外观任务书下发完成时间</span>
                  </div>
                </el-col>
                <el-col :span="16">
              ...
              <el-row :gutter="20">
                ...
                <el-col :span="16">
                  <div class="grid-content bg-purple text-right">
                    <el-button type="info" @click="selectAppearanceFile" size="small"
                      >选择文件</el-button
                    >
                  </div>
                </el-col>
            ...
            <el-col :span="12">
              ...
              <el-row :gutter="20">
                ...
                <el-col :span="16">
                  <div class="grid-content bg-purple text-right">
                    <el-button @click="selectPlanningFile" size="small" type="info"
                      >选择文件</el-button
                    >
                  </div>
                </el-col>
                    ...
                    <el-form-item class="file__upload">
                      <div class="fileListBorder">
                        <el-upload
                          ...
                          :auto-upload="false"
                          :file-list="formData.planningFileList"
                        >
                          <div slot="file" slot-scope="{ file }">
                            <div class="fileListItem clearfix">
                              <el-row :gutter="15">
