...
export default {
  ...
  mounted() {
    ...
    this.getElementToPageTop(this.elSctions[1]);
  ...
  methods: {
    getSectionsData(pageBlock) {
      ...
      const elSection = pageBlock.querySelectorAll("[data-section]")
    ...
    getCurrentSection() {
      ...
      for (let i = 0; i < length; i++) {
        if (
          ...
          console.log("xh", 1);
          console.log("sectionTop", this.getElementToPageTop(sections[i]));
