    ...
    <div class="baseInfo">
      ...
      <el-card class="box-card info-item">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="6"
            ><div class="grid-content">内机控制器负责人：</div></el-col
          >
          <el-col :span="6"
            ><div class="grid-content">外机控制器负责人：</div></el-col
          >

          <el-col :span="6"
            ><div class="grid-content">项目负责人主任：</div></el-col
          >
          <el-col :span="6"
            ><div class="grid-content">印刷负责人主任：</div></el-col
          >
          <el-col :span="6"
            ><div class="grid-content">内机负责人主任：</div></el-col
          >
          <el-col :span="6"
            ><div class="grid-content">外机负责人主任：</div></el-col
          >

          <el-col :span="6"
            ><div class="grid-content">遥控器负责人：</div></el-col
          >
          <el-col :span="6"
            ><div class="grid-content">智能板块负责人：</div></el-col
          >
          <el-col :span="6"
            ><div class="grid-content">产品策划负责人：</div></el-col
          >
          <el-col :span="6"
            ><div class="grid-content">产品策划负责人：</div></el-col
          >
          ...
          >
          <el-col :span="6"
            ><div class="grid-content">遥控器负责人主任：</div></el-col
          >
          <el-col :span="6"
            ><div class="grid-content">智能板块负责人主任：</div></el-col
          >
          <el-col :span="6"
            ><div class="grid-content">产品策划负责人主任：</div></el-col
          >
        </el-row>
      </el-card>
    </div>
