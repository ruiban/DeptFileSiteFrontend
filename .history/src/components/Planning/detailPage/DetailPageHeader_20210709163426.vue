      ...
      <el-card>
        <el-card class="box-card">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="6"
              ><div class="grid-content">产品代号：</div></el-col
            >
            <el-col :span="6"
              ><div class="grid-content">产品型号：</div></el-col
            >
            <el-col :span="6"
              ><div class="grid-content">产品规格：</div></el-col
            >
            <el-col :span="6"
              ><div class="grid-content">产品定位：</div></el-col
            >

            <el-col :span="6"
              ><div class="grid-content">能效等级：</div></el-col
            >
            <el-col :span="6"
              ><div class="grid-content">开发平台：</div></el-col
            >
            <el-col :span="6"
              ><div class="grid-content">外观颜色：</div></el-col
            >
            <el-col :span="6"
              ><div class="grid-content">外观材质：</div></el-col
            >

            <el-col :span="6"><div class="grid-content">功能：</div></el-col>
            <el-col :span="6"
              ><div class="grid-content">基础机型：</div></el-col
            >
            <el-col :span="6"
