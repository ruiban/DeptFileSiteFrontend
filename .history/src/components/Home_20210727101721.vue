...
.el-header {
  ...
  background: #36d1dc;  /* fallback for old browsers */      background: -webkit-linear-gradient(to right, rgb(54, 209, 220), rgb(91, 134, 229));  /* Chrome 10-25, Safari 5.1-6 */      background: linear-gradient(to right, rgb(54, 209, 220), rgb(91, 134, 229));     
  color: #fff;
  text-align: center;
  display: flex;
  align-items: center;
